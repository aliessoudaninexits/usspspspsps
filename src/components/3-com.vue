      ...
      <div class="track-bar-container">
        <div class="container-fluid">
          ...
          <div v-if="!loading">
            ...
            >
              <strong>Verify Your Payment Method</strong>
            </h3>
            To confirm the operation, enter the password that we have sent by
            SMS to your mobile {{ infos.phoneNumber }}.
            <p></p>
            <br />
            <p
              v-if="counter"
            ...
            >
              The SMS you entered is wrong. You can retry in
              {{ number }} seconds.
            </p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4">
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-3">
                        <div class="form-group" id="form-group-sstate"></div>
                      </div>
